...
def main():
    ...
    setup(
        ...
        description=("Python utilities used for simplifying Emailing"),
        url="https://github.com/ChristopherHaydenTodd/ctodd-python-lib-email",
        author="Christopher H. Todd",
        author_email="Christopher.Hayden.Todd@gmail.com",
        classifiers=["Programming Language :: Python"],
        keywords=["python", "libraries", "email", "sendmail"],
        packages=packages,
